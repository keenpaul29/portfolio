...
const techIcons: { [key: string]: React.ReactElement } = {
  ...
  'PostgreSQL': <SiMongodb className="text-[#336791]" />,
  'Material-UI': <SiMongodb className="text-[#007FFF]" />,
  'JavaScript': <SiMongodb className="text-[#F7DF1E]" />,
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {project.tags.slice(0, 4).map((tag, i) => (
                  ...
                  >
                    {techIcons[tag] && React.cloneElement(techIcons[tag], { className: "text-sm" })}
                    {tag}
                  </span>
                ))}
